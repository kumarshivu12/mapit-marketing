    ...
    >
      ...
      >
        <Typography variant="body1">
          ...
          At MapIT.ai, we have developed cutting-edge solutions that harness the
          power of IPS to transform various sectors of the industry.
        </Typography>
        <Typography variant="body1">
          With our IPS technology, we have the ability to revolutionize the way
          businesses and organizations navigate and optimize their indoor
          environments. By leveraging a combination of advanced hardware,
          software algorithms, and wireless communication protocols, our system
